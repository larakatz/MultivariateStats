...
# 
# Firstly,
# ### On MacOS machines, install Xcode by typing the following command in the terminal: 
# ### xcode-select --install. This command will install the necessary compilers.
# ### On Windows machines, Rtools (4.0 and above) must be installed first. Go to:
# https://cran.r-project.org/bin/windows/Rtools/
# ### On Linux machines under Ubuntu, install C compiler in the terminal:
#     sudo apt-get update && sudo apt-get install build-essential
# 
# After that, in the R console or in RStudio:
...
# Place the file in your working directory, then type in the R console or RStudio:
...
# and find the "vegetarian_1.2.tar.gz" file wherever you placed it in your computer.
